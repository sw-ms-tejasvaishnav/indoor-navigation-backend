if (typeof (L) !== 'undefined') {
    ...
    L.CanvasLayer = L.Class.extend({
        ...
        initialize: function (options) {
            ...
            this._canvas.setAttribute('class', "leaflet-custom-canvas-container leaflet-zoom-animated custom-draw-canvas");
        ...
        _createCanvas: function () {
            ...
            var className = 'leaflet-custom-canvas-container leaflet-zoom-animated';
        ...
        __getTransform: function (el) {
            ...
            results[0] = (results[0] - (results[0] * 2)) + 'px';
            results[1] = (results[1] - (results[1] * 2)) + 'px';
            results[2] = (results[2] - (results[2] * 2)) + 'px';
        ...
        onResize: function () {
            ...
            $('.leaflet-custom-canvas-container').css("transform", "translate3d(" + transform + ")");
            $('.custom-draw-canvas').attr("width", mapSize);
